...
export const projects: Project[] = [
  {
    ...
    beforeImages: ["/proyectos/proyecto-1/antes-1.jpg"],
    afterImages: ["/proyectos/proyecto-1/despues-1.jpg"],
  ...
  },
  {
    ...
    beforeImages: ["/proyectos/proyecto-2/antes-1.jpg"],
    afterImages: ["/proyectos/proyecto-2/despues-1.jpg"],
    tags: ["terraza", "apartamento", "curly"],
  },
  {
    id: "3",
    title: "Cancha de pádel club deportivo",
    slug: "cancha-padel-club-deportivo",
    description:
      "Instalación de grama deportiva en cancha de pádel de 200 m².",
    category: "Deportivo",
    location: "Medellín, Antioquia",
    metersInstalled: 200,
    grassUsed: "Grama Pádel Azul",
    beforeImages: ["/proyectos/proyecto-3/antes-1.jpg"],
    afterImages: ["/proyectos/proyecto-3/despues-1.jpg"],
  ...
  },
  {
    ...
    beforeImages: ["/proyectos/proyecto-4/antes-1.jpg"],
    afterImages: ["/proyectos/proyecto-4/despues-1.jpg"],
